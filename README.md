...
Downloads: 
[Download the Excel dataset](data/SubscriptionCohortAnalysisData.xlsx)
...
## 1. What is this project about?
  ...
  Since this is my first 'real case application' I will first be following the recommended questions and maybe include further questions on my own. Those are as follows:
